...
function GridCellGfxComponent(props: GridCellGfxProps) {
...
export const GridCellGfx = memo(GridCellGfxComponent, (prev, next) => {
  return (
    prev.strokeWidth === next.strokeWidth &&
    prev.isHovered === next.isHovered &&
    prev.pathData === next.pathData
    // transformPoint is stable from useMemo in parent
  );
});
